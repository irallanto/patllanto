/* ─────────────────────────────────────────
   ...
   A floating button opens a modal form where visitors can leave a
   name and a short comment for review.
   ───────────────────────────────────────── */
...
async function handleSubmit(e) {
  ...
  const { error } = await supabase.from('comments').insert({ name, role, company, message, status: 'pending' });
