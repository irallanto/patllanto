...
export const projects = {
  preview: [
    { name: 'xStudio',  desc: 'Digital agency that partners with startups and enterprises.', url: 'x-studio-team.vercel.app', href: 'https://x-studio-team.vercel.app', image: 'assets/bg/xstudio.png' },
    { name: 'Kabata',   desc: 'Scalable, child-safe educational gaming platform that supports smartphone controllers.', url: 'kabata.onrender.com', href: 'https://kabata.onrender.com', image: 'assets/bg/kabata.png' },
    { name: 'TaskEase', desc: 'Online task management platform.', url: 'taskease-six.vercel.app', href: 'https://taskease-six.vercel.app', image: 'assets/bg/taskease.png' },
    { name: 'Print-Smart', desc: 'Online UI/UX printing service.', url: 'print-smart-six.vercel.app', href: 'https://print-smart-six.vercel.app', image: 'assets/bg/print-smart.png' },
  ],

  full: [
    { name: 'xStudio',                desc: 'Digital agency that partners with startups and enterprises.',        url: 'x-studio-team.vercel.app',           href: 'https://x-studio-team.vercel.app',       image: 'assets/bg/xstudio.png'       },
    { name: 'Kabata',                 desc: 'Scalable, child-safe educational gaming platform.',                  url: 'kabata.onrender.com',                href: 'https://kabata.onrender.com',            image: 'assets/bg/kabata.png'       },
    { name: 'TaskEase',               desc: 'Online task management platform.',                                   url: 'taskease-six.vercel.app',            href: 'https://taskease-six.vercel.app',        image: 'assets/bg/taskease.png'     },
    { name: 'Print-Smart',            desc: 'Online UI/UX printing service.',                                     url: 'print-smart-six.vercel.app',         href: 'https://print-smart-six.vercel.app',     image: 'assets/bg/print-smart.png'  },
    { name: 'Drip-drop',              desc: 'IoT design for smart home clothesline .',                            url: 'drip-drop-alpha.vercel.app',         href: 'https://drip-drop-alpha.vercel.app',     image: 'assets/bg/drip-drop.png'    },
    { name: 'HCI-2',                  desc: 'UI/UX Design for movie websites.',                                   url: 'hci-2-two.vercel.app',               href: 'https://hci-2-two.vercel.app',          image: 'assets/bg/hci-2.png'       },
    { name: 'StreetSignLearner',      desc: 'Street sign learning app.',                                          url: 'street-sign-learner.vercel.app',     href: 'https://street-sign-learner.vercel.app', image: 'assets/bg/street-sign.png' },
  ],
};
...
export const certifications = [
  { icon: 'assets/icons/watt.png', image: 'assets/certs/watt-cert.png', name: 'Educational Tour', issuer: 'World of Adventures Travel and Tour', desc: 'Awarded a Certificate of Completion for successfully participating in an Educational Tour across Cebu and Bohol, gaining firsthand exposure to leading IT companies and technology organizations.', href: '#' },
  { icon: 'assets/icons/hcdc.png', image: 'assets/certs/hcdc-cert.jpg', name: 'Programming Competition', issuer: 'Holy Cross of Davao College', desc: 'Recognized as Champion in the IT Category Programming Competition during CET TechnoFair 2024, showcasing excellence in programming, logical problem-solving, and innovative technology solutions.', href: '#' },
